  ...
  return (
    <Container>
      <div className="blog-container accordian-height p-5">
        ...
        <Accordion
          defaultActiveKey="0"
          className=" mx-auto mt-3 accordian-container"
        >
          ...
          <Accordion.Item eventKey="1">
            ...
            <Accordion.Body>
              <p>
                ...
                develop, grow and make it a quality app.Moreover, Firebase is
                made with a developer in mind to solve all the issues they might
                ...
                ton of time by providing a simple way to handle the
                sign-in/signup process.The best part is that it builds trust and
                increases the users’ base of your app that makes it more
                professional, better, and faster.
              </p>
            </Accordion.Body>
          </Accordion.Item>
          ...
          <Accordion.Item eventKey="3">
            ...
            <Accordion.Body>
              <p>
                ...
                practice it incurs a great deal of overhead. While spawning
                threads incurs less memory and CPU overhead than forking
                processes, it can still be inefficient. The presence of a large
                number of threads can cause a heavily loaded system to spend
                precious cycles on thread scheduling and context switching,
                which adds latency and imposes limits on scalability and
                throughput.
              </p>
            </Accordion.Body>
          </Accordion.Item>
